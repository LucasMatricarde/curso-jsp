<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <script type="text/javascript" src="<%= request.getContextPath() %>/assets/js/cdn.jsdelivr.net_gh_plentz_jquery-maskmoney@master_dist_jquery.maskMoney.min.js"></script>
